...
const postMessage_1 = __webpack_require__(7965);
...
const p_queue_1 = __importDefault(__webpack_require__(8938)); // tslint:disable-line:import-name
...
const os = __importStar(__webpack_require__(2087));
const packageJson = __webpack_require__(9557); // tslint:disable-line:no-require-imports no-var-requires
/**
...
class Methods extends eventemitter3_1.EventEmitter {
    ...
    constructor() {
        ...
        if (Object() !== WebClient_1.WebClient && !(/* unsupported import.meta.prototype */ undefined instanceof WebClient_1.WebClient)) {

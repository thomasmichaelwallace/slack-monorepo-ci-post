...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield postMessage_1.postMessage(inputs);
        }
        catch (error) {
...
try {
  var supportsColor = __webpack_require__(318);
...
const form_data_1 = __importDefault(__webpack_require__(851)); // tslint:disable-line:import-name
...
const retry = __webpack_require__(347);
...
const WebClient_1 = __webpack_require__(424);
const eventemitter3_1 = __webpack_require__(848);
...
const os = __importStar(__webpack_require__(87));
const packageJson = __webpack_require__(945); // tslint:disable-line:no-require-imports no-var-requires
/**
...
var populate = __webpack_require__(672);

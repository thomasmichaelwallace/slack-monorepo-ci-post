...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield post_message_1.postMessage(inputs);
        }
        catch (error) {
